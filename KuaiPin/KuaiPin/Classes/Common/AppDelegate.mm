...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler
{
    ...
    NSPostNote(Noti_JPUSHService, alert)
    
//    if (IsLogin) {
//        KPMessageViewController *messageVc = [[KPMessageViewController alloc] init];
//        UIViewController *rootVc = self.window.rootViewController;
//        if ([rootVc isKindOfClass:[KPAdViewController class]]) {
//            KPNavigationController *nav = [[KPNavigationController alloc] initWithRootViewController:rootVc];
//            [nav pushViewController:messageVc animated:YES];
//        } else if ([rootVc isKindOfClass:[KPTabBarViewController class]]) {
//            KPTabBarViewController *tabBar = (KPTabBarViewController *)rootVc;
//            KPNavigationController *nav = (KPNavigationController *)tabBar.childViewControllers.firstObject;
//            [nav pushViewController:messageVc animated:YES];
//        }
//    }
}
