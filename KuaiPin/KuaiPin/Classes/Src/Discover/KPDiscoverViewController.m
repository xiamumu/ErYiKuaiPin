...
//    KPInviteViewController *inviteVc = [KPInviteViewController new];
//    [self.navigationController pushViewController:inviteVc animated:YES];
    KPActivityWebViewController *webView = [KPActivityWebViewController new];
    webView.urlStr = @"http://21kp.21my.com/novicePrivilege/novicePrivilege.html";
...
//    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithTitle:@"测试"
//                                                                 titleColor:BlackColor
//                                                            hightLightColor:BlackColor
//                                                                      targe:self
