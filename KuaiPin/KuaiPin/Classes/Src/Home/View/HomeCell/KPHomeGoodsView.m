...
@implementation KPHomeGoodsView
...
{
    KPHomeGoodsView *goodsView = (KPHomeGoodsView *)tap.view;
    NSPostNote(Noti_CheckGoodsDetailAction, goodsView)
}
