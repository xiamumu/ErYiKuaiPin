...
- (void)setAdvancedDay:(NSNumber *)advancedDay {
    _advancedDay = advancedDay;
    self.dayNumLB.text = [NSString stringWithFormat:@"%@", advancedDay];
}

- (void)setAdvancedHour:(NSNumber *)advancedHour {
    _advancedHour = advancedHour;
    self.hourNumLB.text = [NSString stringWithFormat:@"%@", advancedHour];
}
